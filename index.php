...
<div class="article-layout-grid">
	...
	<main id="primary" class="main-content-col">
		...
		<header class="archive-header" style="margin-bottom: 40px; padding-bottom: 20px; border-bottom: 1px dashed var(--color-grid-line);">
			<h1 class="entry-title" style="font-size: 2.25rem;"><?php esc_html_e( 'Latest Engineering & AI Insights', 'cloudtech' ); ?></h1>
			<p style="color: var(--color-text-muted); font-size: 1rem; margin-top: 8px;">
				<?php esc_html_e( 'Deep dives, architectural breakdowns, and announcements from our technical teams.', 'cloudtech' ); ?>
			</p>
		</header>
		...
		<?php else : ?>
			...
			<p><?php esc_html_e( 'No posts found.', 'cloudtech' ); ?></p>
	...
	<aside class="right-sidebar-col">
		<div class="toc-header"><?php esc_html_e( 'SUBSCRIBE TO UPDATES', 'cloudtech' ); ?></div>
		...
		<button class="btn-primary" style="width:100%;"><?php esc_html_e( 'Subscribe', 'cloudtech' ); ?></button>
	</aside>
