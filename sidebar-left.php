...
?>
<aside id="secondary-left" class="left-sidebar-col aria-label="<?php esc_attr_e( 'Left Widget Area', 'cloudtech' ); ?>">
	<div class="left-sidebar-inner">
		...
		if ( is_active_sidebar( 'left-sidebar' ) ) {
			...
			<section class="widget widget_categories">
				<h3 class="widget-title"><?php esc_html_e( 'EXPLORE TOPICS', 'cloudtech' ); ?></h3>
				<ul>
					<?php
					...
					if ( ! empty( $cats ) ) {
						...
						echo '<li><a href="#">' . esc_html__( 'Artificial Intelligence', 'cloudtech' ) . '</a></li>';
						echo '<li><a href="#">' . esc_html__( 'Agentic Web', 'cloudtech' ) . '</a></li>';
						echo '<li><a href="#">' . esc_html__( 'Cloud Security', 'cloudtech' ) . '</a></li>';
						echo '<li><a href="#">' . esc_html__( 'Developer Tools', 'cloudtech' ) . '</a></li>';
					}
					?>
				</ul>
			</section>
			...
			<section class="widget widget_recent_entries">
				<h3 class="widget-title"><?php esc_html_e( 'FEATURED READS', 'cloudtech' ); ?></h3>
				<ul>
					<?php
					...
					if ( ! empty( $recent ) ) {
						...
						echo '<li><a href="#">' . esc_html__( 'Building Autonomous Agents at Scale', 'cloudtech' ) . '</a></li>';
						echo '<li><a href="#">' . esc_html__( 'Zero Trust Security Architectures', 'cloudtech' ) . '</a></li>';
					}
					?>
				</ul>
			</section>
			...
			<div class="discuss-online-block">
				<h3 class="widget-title"><?php esc_html_e( 'DISCUSS ONLINE', 'cloudtech' ); ?></h3>
